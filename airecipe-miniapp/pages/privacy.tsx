...
const SECTIONS: { title: string; body: string[] }[] = [
  {
    ...
    body: [
      ...
      '2. 이용자가 입력한 콘텐츠: 요리명, 인분, 상황·날씨 등 추천 테마, 저장한 레시피 데이터, 요리 기록을 위해 이용자가 직접 첨부한 요리 사진·별점·소감',
  ...
  },
  {
    ...
    body: [
      ...
      '2. 이용자가 첨부한 요리 사진은 비공개 클라우드 스토리지에 저장되며, 조회 시 만료 시간이 있는 서명 URL로만 제공됩니다. 이용자가 해당 기록을 삭제하면 저장된 사진도 함께 삭제됩니다.',
      '3. 관련 법령에 따라 보존이 필요한 경우 해당 법령이 정한 기간 동안 보관하며, 그 외의 경우 목적 달성 후 지체 없이 파기합니다.',
    ],
  },
  {
