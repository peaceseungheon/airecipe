 ...
 *   - 개인정보 보호책임자 성명·연락처(아래 [보호책임자] placeholder).
 *   - 고객센터 문의 채널(앱인토스 콘솔 고객센터 연동 — 아래 [고객센터] placeholder).
 *   - 사업자 법인명(개인정보처리자 식별 정보) — 콘솔 등록값과 동기.
 */
...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '- 개인정보 보호책임자: [보호책임자 성명·직책 — 출시 전 확정]',
      '- 문의(고객센터): [고객센터 — 앱인토스 콘솔 고객센터 채널 연동, 출시 전 확정]',
    ],
  },
  {
