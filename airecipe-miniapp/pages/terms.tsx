 ...
 *
 * [ ] 출시 전 채울 항목 (architect/사업자 정보 확정 후):
 *   - 제10조 준거법/관할 법원의 사업자 소재지(아래 [관할 법원] placeholder).
 *   - 회사 법인명·대표자·사업자등록번호(제2조 정의의 "회사" 식별 정보) — 콘솔 등록값과 동기.
 */
...
const ARTICLES: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '2. 서비스 이용과 관련하여 분쟁이 발생한 경우, 당사자 간 협의를 통한 원만한 해결을 우선으로 하며, 협의가 이루어지지 않을 경우 관련 법령이 정한 절차에 따릅니다. (관할 법원: [관할 법원 — 출시 전 사업자 소재지 기준 확정])',
    ],
  },
];
