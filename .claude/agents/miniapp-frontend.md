...
- **컴포넌트는 단일 책임**: 거대 화면 컴포넌트를 피하고 표현/컨테이너를 분리. 패턴은 `software-design-principles` 스킬.
...
- 컴포넌트 분리/패턴: `software-design-principles` 스킬.
- 화면별 문서·주석 정책: `technical-documentation` 스킬.
